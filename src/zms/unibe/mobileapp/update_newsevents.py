from sqlmodel import select, or_, inspect, Session
from uuid import UUID, uuid4
from datetime import datetime

from .sqlmodels import NewsEvents
from ..agenda.sqlmodels import AgendaFilemaker, AgendaLibraryDE, AgendaLibraryEN
from ..teasers.sqlmodels import TeaserElement2022
from ..announcements.sqlmodels import NewsBox


def update_newsevents_table(*args):
